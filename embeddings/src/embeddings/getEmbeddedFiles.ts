...
import {
  type GetEmbeddedFilenames,
  type GetEmbeddedTextChunk,
} from 'wasp/server/operations'

export const getEmbeddedFilenames: GetEmbeddedFilenames<
  never,
  string[]
> = async (_args, context) => {
...
export const getEmbeddedTextChunk: GetEmbeddedTextChunk<
  string,
  TextChunkWithParentFile
> = async (id, context) => {
